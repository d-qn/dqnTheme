...
#' @rdname theme_lt
#' @param panel.background.colour a string of length 1 hex string colour for the chart background
#' @import ggplot2 
#' @import gridExtra
#' @importFrom grid unit
#' @importFrom extrafont loadfonts choose_font
  ...
  ) 
{
  ...
  ret + theme(
    plot.background = element_rect(fill = panel.background.colour, colour = NA),
    panel.background = element_rect(fill = panel.background.colour, colour = NA)
  )
}
